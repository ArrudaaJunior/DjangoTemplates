...
SECRET_KEY = 'django-insecure-2y-t+u)2tfehhgk=gbq-$jq1ta_l*e+!gc3qj@fz7==-d@-!d%'
...
ALLOWED_HOSTS = ['*']  # Colocar o URL verdadeira aqui!
...
# Redirecionamento do Usuario ADM para a pagina Index
